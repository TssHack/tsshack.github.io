        ...
        var p = function () {
          ...
          y = function () {
            var e = (0, b.default)(function* () {
              ...
              if ("" !== e[0].text.trim()) {
                f(!0), a((t) => v.GiftedChat.append(t, e));
                try {
                  const query = encodeURIComponent(e[0].text); // Encode the message
                  const response = yield fetch(
                    `https://req.wiki-api.ir/apis-2/ChatGPT4?q=${query}`,
                    {
                  ...
                  const botMessage = {
                    ...
                    text: data.results, // Use the results directly
                  ...
                  f(!1), a((e) => v.GiftedChat.append(e, botMessage));
                } catch (s) {
